...
from windowed_audio_datasets import FolderTripletDataset # Updated import
...
def train(args):
    ...
    train_dataset = FolderTripletDataset(root_path, split="train", segment_length_sec=args.segment, hop_length_sec=args.hop_length_sec, sr=args.sr) # Updated instantiation
    ...
    if (root_path / "val").exists():
        ...
        val_split_name = "val"
    val_dataset = FolderTripletDataset(root_path, split=val_split_name, segment_length_sec=args.segment, hop_length_sec=args.hop_length_sec, sr=args.sr) # Updated instantiation
    ...
    if best_model_path.exists():
        ...
        try:
            test_dataset = FolderTripletDataset(root_path, split="test", segment_length_sec=args.segment, hop_length_sec=args.hop_length_sec, sr=args.sr) # Updated instantiation
...
if __name__ == "__main__":
    ...
    parser.add_argument('--hop_length_sec', type=float, default=0.2, help='Hop length for audio segments in seconds') # Added hop_length_sec
